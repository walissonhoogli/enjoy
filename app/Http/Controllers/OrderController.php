...
class OrderController extends Controller
{
    ...
    public function listaPostagem(Request $request)
    {
        CoreComponentRepository::instantiateShopRepository();
        ...
        $query->whereBetween('postagem.data', [$startDate, $endDate]);
        ...
        return view('backend.correios.index', compact('postagens', 'date', 'qtd'));
    ...
    public function store(Request $request)
    {
        ...
        if ($address != null) {
            ...
            $shippingAddress['correios']    = $address->correios;
            $shippingAddress['valor_correios'] =  $address->valor_correios;
