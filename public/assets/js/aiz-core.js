    ...
    AIZ.plugins = {
        ...
        dateRange: function () {
            $(".aiz-date-range").each(function () {
                ...
                var ranges = {
                    ...
                    "Last 7 Dias": [moment().subtract(6, "days"), moment()],
                    "Last 30 Dias": [moment().subtract(29, "days"), moment()],
                    "This Month": [
        ...
        countDownCircle: function () {
            let html =  '<div id="time"><div class="circle"><svg><circle cx="30" cy="30" r="30"></circle><circle cx="30" cy="30" r="30" id="dd"></circle></svg><div id="days">00 <br><span>Dias</span></div></div>' +
                        ...
                        '<div class="circle"><svg><circle cx="30" cy="30" r="30"></circle><circle cx="30" cy="30" r="30" id="ss"></circle></svg><div id="seconds">00 <br><span>Seg</span></div></div></div>';
