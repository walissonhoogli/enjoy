                        ...
                        <div class="p-4 bg-primary @if(!addon_is_activated('club_point')) h-100 @endif" style="margin-bottom: 2rem;">
                            <div class="d-flex align-items-center pb-4 ">
                                ...
                                <div class="ml-3 d-flex flex-column justify-content-between">
                                    ...
                                    @endphp
                                    <span class="fs-14 fw-400 text-white mb-1">Despesa total</span>
            ...
            <div class="px-4 bg-white border h-100">
                ...
                <div class="d-flex align-items-center py-4 border-bottom">
                    ...
                    <div class="ml-3 d-flex flex-column justify-content-between">
                        ...
                        <span class="fs-14 fw-400 text-secondary">Produtos no carrinho</span>
                    </div>
                </div>
                ...
                <div class="d-flex align-items-center py-4 border-bottom">
                    ...
                    <div class="ml-3 d-flex flex-column justify-content-between">
                        ...
                        <span class="fs-14 fw-400 text-secondary">Produtos na lista de desejo</span>
                    </div>
                </div>
                ...
                <div class="d-flex align-items-center py-4">
                    ...
                    <div class="ml-3 d-flex flex-column justify-content-between">
                        ...
                        <span class="fs-14 fw-400 text-secondary">Total de produtos pedidos</span>
                    </div>
                </div>
        ...
        <div class="row">
            <div class="col">
                <div class="text-center bg-white p-4 border">
                    ...
                    <h5 class="mb-0 h5 mt-3">Ainda não há nada adicionado</h5>
                </div>
            </div>
        </div>
    @endif
