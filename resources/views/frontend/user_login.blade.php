                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-md-7 p-4 p-lg-5">
                                    ...
                                    <div class="text-center">
                                        <h1 class="fs-20 fs-md-24 fw-700 text-primary">Bem vindo!</h1>
                                            ...
                                            <form class="form-default" role="form" action="{{ route('login') }}" method="POST">
                                                ...
                                                @if (addon_is_activated('otp_system') && env("DEMO_MODE") != "On")
                                                    ...
                                                    <div class="form-group email-form-group mb-1 d-none">
                                                        ...
                                                        <input type="email" class="form-control rounded-0 {{ $errors->has('email') ? ' is-invalid' : '' }}" value="{{ old('email') }}" placeholder="Seu e-mail" name="email" id="email" autocomplete="off">
                                                        @if ($errors->has('email'))
                                                ...
                                                @else
                                                    <div class="form-group">
                                                        <label for="email" class="fs-12 fw-700 text-soft-dark">{{  translate('Email') }}</label>
                                                        <input type="email" class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }} rounded-0" value="{{ old('email') }}" placeholder="Seu e-mail" name="email" id="email" autocomplete="off">
                                                        @if ($errors->has('email'))
                                                            <span class="invalid-feedback" role="alert">
                                                                <strong>{{ $errors->first('email') }}</strong>
                                                            </span>
