        ...
        <table class="table" style="margin-top: 2rem!important;">
            <tfoot>
                ...
                <tr class="cart-shipping">
                    ...
                    <td class="text-right pr-0 fs-14 pt-0 pb-2 fw-600 text-primary border-top-0">
                        <span class="fw-600">{{ $valorFormatado }}</span>
                         <input type="hidden" name="valor_correios" value="{{ $valor }}">
                         <input type="hidden" name="name_correios" value="{{ $correios['name_correios'] }}">
                    </td>
                </tr>
                <!-- Redeem point -->
