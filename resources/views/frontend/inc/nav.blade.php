                    ...
                    <div class="d-flex align-items-center justify-content-center justify-content-xl-start h-100">
                        <ul class="list-inline mb-0 pl-0 hor-swipe c-scrollbar-light">
                            <li class="list-inline-item mr-0 animate-underline-white">
                                <a href="." class="fs-13 px-3 py-3 d-inline-block fw-700 text-white header_menu_links hov-bg-black-10">Home</a>
                            </li>
                            <li class="list-inline-item mr-0 animate-underline-white">
                                <a href="/flash-deals" class="fs-13 px-3 py-3 d-inline-block fw-700 text-white header_menu_links hov-bg-black-10">Oferta Relâmpago</a>
                            </li>
                            <li class="list-inline-item mr-0 animate-underline-white">
                                <a href="/blog" class="fs-13 px-3 py-3 d-inline-block fw-700 text-white header_menu_links hov-bg-black-10">Blog</a>
                            </li>
                            <li class="list-inline-item mr-0 animate-underline-white">
                                <a href="/categories" class="fs-13 px-3 py-3 d-inline-block fw-700 text-white header_menu_links hov-bg-black-10">Categorias</a>
                            </li>
