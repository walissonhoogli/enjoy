                                                ...
                                                <div class="row gutters-5">
                                                    ...
                                                    <div class="col-6">
                                                        <label class="aiz-megabox d-block bg-white mb-0">
                                                            ...
                                                            <span class="d-flex aiz-megabox-elem rounded-0" style="padding: 0.75rem 1.2rem;">
                                                                <span class="aiz-rounded-check flex-shrink-0 mt-1"></span>
                                                                <span class="flex-grow-1 pl-3 fw-600">Correios</span>
                                                            </span>
                                                        </label>
                                                    </div>
                                                    @endif
                                                    ...
                                                    <div class="col-md-12 mb-2">
                                                        <label class="aiz-megabox d-block bg-white mb-0">
                                                            ...
                                                            <span class="d-flex p-3 aiz-megabox-elem rounded-0">
                                                                ...
                                                                <span class="flex-grow-1 pl-3 fw-600">{{ 'Prazo' .' '.$carrier['correios']->prazoEntrega.' '. 'dias' }}</span>
                                                                @php
                                                                    $valor = $carrier['correios']->valor;
                                                                    $valorFormatado = 'R$ ' . number_format($valor, 2, ',', '.');
                                                                @endphp
                                                                <span class="flex-grow-1 pl-3 fw-600">{{ $valorFormatado}}</span>
                                                                <input type="hidden" name="correios_id" value="{{  $carrier->id }}">
                                                                <input type="hidden" name="valor_correios" value="{{ $valor }}">
                                                            </span>
                                                        </label>
                                                    </div>
                                                @endforeach
