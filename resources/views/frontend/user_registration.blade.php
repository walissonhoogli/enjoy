                                    ...
                                    <div class="pt-3 pt-lg-4">
                                        <div class="">
                                            <form id="reg-form" class="form-default" role="form" action="{{ route('register') }}" method="POST">
                                                ...
                                                <!-- CPF -->
                                                <div class="form-group">
                                                    <label for="name" class="fs-12 fw-700 text-soft-dark">CPF</label>
                                                    <input type="text" class="form-control rounded-0{{ $errors->has('cpf') ? ' is-invalid' : '' }}" value="{{ old('cpf') }}" placeholder="CPF" name="cpf" maxlength="11">
                                                    @if ($errors->has('cpf'))
                                                        <span class="invalid-feedback" role="alert">
