            ...
            <div class="col-lg-8">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            <label class="col-md-3 col-from-label">Peso<small>({{ translate('In Kg') }})</small></label>
                            <div class="col-md-8">
                                <input type="number" class="form-control" name="weight" value="{{ $product->weight }}" step="0.01" placeholder="0.00">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-lg-3 col-from-label">Quantidade Mínima de Compra</label>
                            <div class="col-lg-8">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <div class="input-group" data-toggle="aizuploader" data-type="image" data-multiple="true">
                                    ...
                                    <div class="form-control file-amount">Escolha um arquivo</div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            <label class="col-sm-3 col-from-label" for="start_date">Intervalo de datas de desconto</label>
                            <div class="col-sm-9">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input type="text" placeholder="Link Externo" name="external_link" value="{{ $product->external_link }}" class="form-control">
                                <small class="text-muted">Deixe em branco se não usar link de site externo</small>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-md-3 col-from-label">
                               Texto do botão de link externo
                            </label>
                            <div class="col-md-9">
                                <input type="text" placeholder="Texto do botão de link externo" name="external_link_btn" value="{{ $product->external_link_btn }}" class="form-control">
                                <small class="text-muted">Deixe em branco se não usar link de site externo</small>
                            </div>
                        </div>
                        <br>
            ...
            <div class="col-lg-4">
                ...
                <div class="card">
                    ...
                    <div class="card-body collapse show" id="collapse_2">
                        ...
                        @else
                        <p>
                            O custo de envio do produto está desativado. O custo de envio é configurado a partir daqui 
                ...
                <div class="card">
                    <div class="card-header">
                        <h5 class="mb-0 h6">Aviso de quantidade de estoque baixo</h5>
                    </div>
                    <div class="card-body">
                ...
                <div class="card">
                    <div class="card-header">
                        <h5 class="mb-0 h6">
                            Estado de Visibilidade do Estoque
                        </h5>
                    </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            <label class="col-md-6 col-from-label">Mostrar quantidade de estoque</label>
                            <div class="col-md-6">
                                <label class="aiz-switch aiz-switch-success mb-0">
                        ...
                        <div class="form-group row">
                            <label class="col-md-6 col-from-label">Mostrar estoque apenas com texto</label>
                            <div class="col-md-6">
                                <label class="aiz-switch aiz-switch-success mb-0">
                        ...
                        <div class="form-group row">
                            <label class="col-md-6 col-from-label">Ocultar Estoque</label>
                            <div class="col-md-6">
                                <label class="aiz-switch aiz-switch-success mb-0">
                ...
                <div class="card">
                    <div class="card-header">
                        <h5 class="mb-0 h6">Oferta Relaâmpago</h5>
                    </div>
                    <div class="card-body">
                        <div class="form-group mb-3">
                            <label for="name">
                ...
                <div class="card">
                    <div class="card-header">
                        <h5 class="mb-0 h6">Estimar o tempo de envio</h5>
                    </div>
                    <div class="card-body">
                        <div class="form-group mb-3">
                            <label for="name">
                            ...
                            <div class="input-group">
                                <input type="number" class="form-control" name="est_shipping_days" value="{{ $product->est_shipping_days }}" min="1" step="1" placeholder="Dias de envio">
                                <div class="input-group-prepend">
