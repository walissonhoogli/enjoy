                ...
                @canany(['view_all_orders', 'view_inhouse_orders','view_seller_orders','view_pickup_point_orders'])
                    <li class="aiz-side-nav-item">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            ...
                            @can('view_all_orders')
                                <li class="aiz-side-nav-item">
                                    <a href="{{ route('lista_postagem.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['lista_postagem.index', 'lista_postagem.show'])}}">
                                        <span class="aiz-side-nav-text">Lista de Postagem</span>
                                    </a>
                                </li>
                            @endcan
